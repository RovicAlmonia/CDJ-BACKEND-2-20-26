...
module.exports.routes = {
    post: [
        ...
        ['/activate-client',          AdminCtrl.activateClient],
        ['/decline-client',           AdminCtrl.declineClient],
        ['/mark-notification-read',   AdminCtrl.markNotificationRead],
    ],
    get: [
        ...
        ['/get-notifications',        AdminCtrl.getNotifications],
    ],
    remove: [
